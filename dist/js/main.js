...
/* harmony import */ var _smoothScroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./smoothScroll */ "./src/js/smoothScroll.js");



Object(_smoothScroll__WEBPACK_IMPORTED_MODULE_2__["smoothScroll"])();
...
function smoothScroll() {
  ...
  var firstFocusableElement = document.querySelector('a, area, input, button, select, option, textarea, output, summary, video, audio, object, embed, iframe'); // 機能実行

  anc.forEach(function (i) {
    setSmoothScroll(i);
  });
    ...
    SmoothScroll.prototype = {
      ...
      clickHandler: function clickHandler() {
        ...
        this.root.addEventListener('click', function (e) {
          ...
          var startPosition = window.pageYOffset; // クリックした時の縦軸の座標

          var targetPosition = null; // ページ内リンクかトップへのリンクかにより変動するため宣言のみ行う

          var reachingPosition = null; // 最終的な到着地点
          ...
          var move = function move(timeCurrent) {
            return new Promise(function (resolve) {
              ...
              elapsedTime = timeCurrent - timeStart; // IEチラつき対策
